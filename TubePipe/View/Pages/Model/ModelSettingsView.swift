...
struct ModelSettingsView:View{
    ...
    //MARK: - SWITCHES
    @ViewBuilder
    func modelSwitchSection(header:String,index:Int,clearConnectedIndexes:[Int]) -> some View{
        HStack{
    ...
    func modelSwitchSectionBase(index:Int) -> some View{
        ...
        case DrawOption.indexOf(op: .FULL_SIZE_MUFF):
            modelSwitchSection(header: "Full size",
        ...
        case DrawOption.indexOf(op: .SCALED_SIZE_MUFF):
            modelSwitchSection(header: "Scaled size",
